...
model.func("an2").set("expr", "0.001*((u/uss)^2-1)");

% Set the kinetic parameters and diffusion ratio
%a = 0.01;model.param.set('a', a);
%b = 1.1;model.param.set('b', b);
%D = 400;model.param.set('D', D);
...
for iter = 1 : num_iterations
    ...
    ts = ((iter-1)*iter_length:5:iter*iter_length)'; % start:step:stop
